...
-- Dumping data for table gestion.pay: ~97 rows (approximately)
DELETE FROM `pay`;
...
INSERT INTO `produit` (`ID_pro`, `nom`, `Qte`, `id_ad`, `id_ca`, `prix`, `img`, `visible`) VALUES
	(1, 'activia', 100, 2, 1, 3, 'activia.jpg', 0),
	(2, 'danette', 61, 2, 1, 2, 'danette.jpg', 1),
	(3, 'tv samsung 4k', 97, 2, 2, 4000, 'tv samsung 4k.jpg', 1),
	(4, 'orange', 88, 2, 3, 7, 'orange.jpg', 1);
...
INSERT INTO `user` (`id_user`, `username`, `email`, `pass`, `idrole`) VALUES
	(1, 'hichamboudanes', 'hicham.boudanes@gmail.com', '1234567', 3),
